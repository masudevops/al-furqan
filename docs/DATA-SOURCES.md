...
| Hadith | fawazahmed0/hadith-api via jsDelivr | Browse/search Arabic + English records with references and named grades | Dataset repository states Unlicense/public domain; CDN revalidated daily; exact provider text/metadata only | Active through swappable adapter; incomplete/ungraded records are withheld; Sunnah.com replacement/dual-source planned |
