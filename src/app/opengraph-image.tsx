...
export const alt = "Al-Furqan — A quiet place to return to the Quran";
    ...
    <div style={{ alignItems: "stretch", background: "#f6f2e8", color: "#17231c", display: "flex", height: "100%", padding: 56, width: "100%" }}>
      <div style={{ border: "2px solid #d8cfbb", display: "flex", flex: 1, flexDirection: "column", justifyContent: "space-between", padding: "46px 54px" }}>
        <div style={{ alignItems: "center", display: "flex", gap: 20 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}><span style={{ fontFamily: "serif", fontSize: 35, fontWeight: 700 }}>Al-Furqan</span><span style={{ color: "#52675d", fontSize: 17, letterSpacing: 3, textTransform: "uppercase" }}>Quran & Worship Companion</span></div>
        </div>
        <div style={{ display: "flex", flexDirection: "column", maxWidth: 900 }}>
          ...
          <span style={{ fontFamily: "serif", fontSize: 68, fontWeight: 500, letterSpacing: -2, lineHeight: 1.05 }}>A quiet place to return to the Quran.</span>
          <span style={{ color: "#52675d", fontSize: 24, lineHeight: 1.5, marginTop: 22 }}>Tajweed · Translations · Tafsir · Audio · Salah · Dua · Qibla</span>
        </div>
